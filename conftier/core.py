...
class ConfigManager(Generic[T]):
    ...
    def load(self) -> T:
        ...
        Raises:
            FileNotFoundError: If both user and project configuration files don't exist and
                               auto_create options are disabled
        """
        ...
        if not user_config_exists and not project_config_exists:
            ...
            error_message += "Use create_user_config_template() or create_project_config_template() to create them, "
